...
public record CreateFavoriteCommentResource(String name, String image, String content, String ranklvl, Integer likes, Integer dislikes) {
    public CreateFavoriteCommentResource {
